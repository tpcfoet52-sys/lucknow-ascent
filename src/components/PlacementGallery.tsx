...
const galleryItems = [
  {
    ...
    description: "Over 50 students selected for SDE and PM roles",
    company: "Microsoft",
    students: 52,
  },
  {
    ...
    description: "Record placements in AWS and retail divisions",
    company: "Amazon",
    students: 38,
  },
  {
    id: 3,
    title: "Deloitte Consulting Week",
    description: "Consulting and technology roles across practices",
    company: "Deloitte",
    students: 45,
  },
  {
    ...
    description: "Premium package offers for top performers",
    company: "TCS",
    students: 120,
  },
];
