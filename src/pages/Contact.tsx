                    ...
                    <div className="container-narrow">
                        ...
                        >
                            ...
                            <div className="grid md:grid-cols-3 gap-4">
                                ...
                                >
                                    <div className="p-3 border-b border-border flex flex-col items-center justify-center text-center gap-1">
                ...
                <section className="section-padding">
                    <div className="container-narrow">
                        ...
                        <div className="grid lg:grid-cols-2 gap-6">
                            ...
                            >
                                <iframe
                                    src="https://maps.google.com/maps?q=University+of+Lucknow+New+Campus+Jankipuram+Extension&t=&z=15&ie=UTF8&iwloc=&output=embed"
                                    width="100%"
                                    height="100%"
                                    style={{ border: 0 }}
                                    allowFullScreen
